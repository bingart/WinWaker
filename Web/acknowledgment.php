...
<title>WinWaker Acknowledgment</title>
<?php
	include "meta.php";
?>
...
<div id="page">
	...
	<div id="content">
		...
		<div class="post">
			...
			<div class="entry">
				<p>
					The WinWaker icon is regenerated from Microsoft MSN;<br>
					The WinWaker animation GIF comes from  <a href="http://www.bing.com/">Bing</a>;<br>
					Thanks all above resources !!!
				</p>
			</div>
			<p class="meta"></p>
		</div>
